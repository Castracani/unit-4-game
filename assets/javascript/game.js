...
console.log(pulledCrystalValues);
...
for (i = 0; i < pulledCrystalIntegers.length; i++) {
 ...
 $("#crystal0").attr("data-crystalValue",pulledCrystalIntegers[0]);
 $("#crystal1").attr("data-crystalValue", pulledCrystalIntegers[1]);
 $("#crystal2").attr("data-crystalValue", pulledCrystalIntegers[2]);
 $("#crystal3").attr("data-crystalValue", pulledCrystalIntegers[3]);
